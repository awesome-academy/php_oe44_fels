        ...
        <div class="main-body">
            <div class="page-wrapper">
                ...
                <div class="col-sm">
                    ...
                    @endif
                    <div class="row">
                        <form class="col-7" action="{{route('courses.store')}}" method="POST">
                            @csrf
                            <div class="form-group mb-2">
                                <label class="mb-2 " for="name_task">@lang('name_course')</label>
                                <input type="text" class="form-control" id="name" name="name" placeholder='@lang("Enter") @lang("name_course")'>
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-group mb-2">
                                <label class="mb-2 " for="name_task">@lang('topic_of_course')</label>
                                <select id="" name="topic_id" class="form-control">
                    ...
                    <table class="mt-5 col-6 table  table-striped">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">@lang('name_course')</th>
                                <th scope="col">@lang('topic_of_course')</th>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">@lang('edit_course')</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <form action="{{ route('courses.update', $item)}}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">@lang('name_course'):</label>
                                                            <input type="text" class="form-control" value="{{ $item->name }}" name="name" id="recipient-name">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">@lang('topic_of_course'):</label>
                                                            <select id="" name="topic_id" class="form-control">
                                                                @foreach($topics as $topic)
